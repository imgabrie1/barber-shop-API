...
export class InitialEntities1781909941577 implements MigrationInterface {
    name = 'InitialEntities1781909941577'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "shops" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(100) NOT NULL, "address" character varying(255), "isActive" boolean NOT NULL DEFAULT true, "alwaysOpen" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_3c6aaa6607d287de99815e60b96" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "shop_schedules" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "dayOfWeek" integer NOT NULL, "startHour" integer NOT NULL DEFAULT '8', "endHour" integer NOT NULL DEFAULT '18', "isOpen" boolean NOT NULL DEFAULT true, "shopId" uuid, CONSTRAINT "PK_b0062efec500477e5ac450ec5b9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "shop_schedules" ADD CONSTRAINT "FK_07b4aa7e42fdeabbfc339998766" FOREIGN KEY ("shopId") REFERENCES "shops"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "shop_schedules" DROP CONSTRAINT "FK_07b4aa7e42fdeabbfc339998766"`);
        ...
        await queryRunner.query(`DROP TABLE "shop_schedules"`);
